<?php
	...
	$mysqli=new mysqli("localhost","root","","volarenglobo"); //servidor, usuario de base de datos, contraseña del usuario, nombre de base de datos
	...
	//Consulta
	$sql = "SELECT id_usu as id, nombre_usu as nombre,puesto_usu as precio, depto_usu as existencia FROM volar_usuarios";
