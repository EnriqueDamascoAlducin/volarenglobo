...
<?php function campos($tipo ,$comentario,$campo2,$tamano,$options,$datos,$req,$cons){ ?>
	...
	<?php if($tipo==1){ ?>
		<div  class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
			<div class="form-group">
				...
				<input type="text"  name="<?php echo $campo ?>" placeholder="<?php echo utf8_encode($comentario) ?>" class="form-control" id="<?php echo $campo; ?>" value="<?php if($datos!='' && $datos[0]->$campo2!=''){ echo($datos[0]->$campo2);}else{ echo '';} ?>"<?php echo $req; ?> />
			</div>
		</div>
	<?php } else if($tipo==2) { ?>
		<div class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
			<div class="form-group">
				<label for="<?php echo $campo ?>" <?php echo $color; ?>><?php echo utf8_encode($comentario); ?></label>
				<input type="number"  step=".01" name="<?php echo $campo ?>" placeholder="<?php echo utf8_encode($comentario)?>" class="form-control" id="<?php echo $campo; ?>" value="<?php if($datos!='' && $datos[0]->$campo2!=''){ echo($datos[0]->$campo2);}else{ echo '';} ?>"<?php echo $req; ?>/>
			</div>
		</div>
	...
	<div class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
			<div class="form-group">
				<label for="<?php echo $campo ?>" <?php echo $color; ?>><?php echo utf8_encode($comentario); ?></label>
				<input type="date"  name="<?php echo $campo ?>" placeholder="<?php echo  utf8_encode($comentario) ?>" class="form-control" id="<?php echo $campo; ?>"  value="<?php if($datos!='' && $datos[0]->$campo2!=''){ echo($datos[0]->$campo2);}else{ echo '';} ?>"<?php echo $req; ?> />
			</div>
		</div>
	<?php } else if($tipo==8){ ?>
	<div class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
			<div class="form-group">
				<label for="<?php echo $campo ?>" <?php echo $color; ?>><?php echo utf8_encode($comentario); ?></label>
				<input type="datetime-local"  name="<?php echo $campo ?>" placeholder="<?php echo utf8_encode($comentario) ?>" class="form-control" id="<?php echo $campo; ?>"  value="<?php if($datos!='' && $datos[0]->$campo2!=''){ echo($datos[0]->$campo2);}else{ echo '';} ?>"<?php echo $req; ?>/>
			</div>
		</div>
	<?php } else if($tipo==9){ ?>
	<div class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
			<div class="form-group">
				<label for="<?php echo $campo ?>" <?php echo $color; ?>><?php echo utf8_encode($comentario); ?></label>
				<input type="email"  name="<?php echo $campo ?>" placeholder="<?php echo utf8_encode($comentario) ?>" class="form-control" id="<?php echo $campo; ?>" value="<?php if($datos!='' && $datos[0]->$campo2!=''){ echo($datos[0]->$campo2);}else{ echo '';} ?>"<?php echo $req; ?> />
			</div>
		</div>
	<?php } else if($tipo==10){ ?>
	<div class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
			<div class="form-group">
				<label for="<?php echo $campo ?>" <?php echo $color; ?>><?php echo utf8_encode($comentario); ?></label>
				<input type="tel"  name="<?php echo $campo ?>" title="(Ej.55-1234-5678)" placeholder="<?php echo utf8_encode($comentario) ?>" class="form-control" id="<?php echo $campo; ?>" value="<?php if($datos!='' && $datos[0]->$campo2!=''){ echo($datos[0]->$campo2);}else{ echo '';} ?>"<?php echo $req; ?> pattern="[0-9]{2}-[0-9]{4}-[0-9]{4}" />
			</div>
	</div>
	<?php } else if($tipo==11){ ?>
	<div class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
			<div class="form-group">
				<label for="<?php echo $campo ?>" <?php echo $color; ?>><?php echo utf8_encode($comentario); ?></label>
				<input type="checkbox"  name="<?php echo $campo ?>" title="<?php echo utf8_encode($comentario) ?>" class="form-control" id="<?php echo $campo; ?>" value="<?php if($datos!='' && $datos[0]->$campo2!=''){ echo($datos[0]->$campo2);}else{ echo '';} ?>"<?php echo $req; ?> pattern="[0-9]{2}-[0-9]{4}-[0-9]{4}" />
			</div>
	</div>
	<?php } else if($tipo==12){ ?>
	<div class="col-sm-<?php echo $tamano; ?> col-md-<?php echo $tamano; ?> col-lg-<?php echo $tamano; ?> col-xs-6" id="div_<?php echo $campo; ?>">
